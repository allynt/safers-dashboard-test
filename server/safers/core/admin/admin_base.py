...
class CannotAddModelAdminBase(BaseModelAdmin):
    """
    Prevents adding new model instances via the admin
    """
...
class CannotDeleteModelAdminBase(BaseModelAdmin):
    """
    Prevents deleting model instances via the admin
    """
...
class CannotUpdateModelAdminBase(BaseModelAdmin):
    """
    Prevents updating existing model instances via the admin
    """
    def changeform_view(
...
class CannotEditModelAdminBase(BaseModelAdmin):
    """
    Prevents editing existing model instance fields via the admin
    """
...
class ReadOnlyModelAdminBase(
    ...
    """"
    Prevents doing anything to a model instance via the admin
    """
    actions = None
